...
DROP SCHEMA AP4_EXERCICIOS IF EXISTS CASCADE;

CREATE SCHEMA AP4_EXERCICIOS AUTHORIZATION DBA;

SET INITIAL SCHEMA AP4_EXERCICIOS;
SET DATABASE DEFAULT INITIAL SCHEMA AP4_EXERCICIOS;

-- ATENÇÃO: para usar nomes case-insentitive, precisa desabilitar um recurso do spring-data-jdbc.

CREATE TABLE ap4_exercicios.usuario(
...
CREATE TABLE ap4_exercicios.post(
     id              BIGINT          NOT NULL AUTO_INCREMENT,
     data_postagem   DATETIME        NOT NULL,
     mensagem        VARCHAR(2200)   NOT NULL,
     usuario_id      BIGINT          NOT NULL,
     CONSTRAINT PK_POST              PRIMARY KEY (id),
     CONSTRAINT PK_POST_USUARIO_ID   FOREIGN KEY (usuario_id) REFERENCES ap4_exercicios.usuario(id)
)

CREATE TABLE ap4_exercicios.post_tag(
     post_id           BIGINT          NOT NULL,
     nome              VARCHAR(255)    NOT NULL,
     ordem             INT             NOT NULL DEFAULT 0,
     CONSTRAINT PK_POST_TAG    PRIMARY KEY (post_id, nome),
     CONSTRAINT UK_POST_TAG_POST   FOREIGN KEY (post_id) REFERENCES ap4_exercicios.post(id)
);



-- 1. Inserindo 5 Usuários
INSERT INTO ap4_exercicios.usuario (id, username, nome, idade, url_imagem) VALUES
...
INSERT INTO ap4_exercicios.post (id, data_postagem, mensagem, usuario_id) VALUES
...
INSERT INTO ap4_exercicios.post_tag (post_id, nome, ordem) VALUES
